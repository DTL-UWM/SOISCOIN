...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/soiscoin-project/soiscoin>";
    const std::string URL_WEBSITE = "<https://soiscoin.org>";
