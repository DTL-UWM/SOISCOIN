...
{
    const char* pszTimestamp = "With new technology in hand, UWM students build school’s own cryptocurrency";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1555975847, 2085067807, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf02bab15d33de92e68fc59bf4ab08a3ac4964ec5a5b821412152cecfd33b95af"));
        assert(genesis.hashMerkleRoot == uint256S("0xd6a218f16a2361ae76271753045a69777aff83b648f7757261f95f647f4e618a"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        /*vSeeds.emplace_back("seed-a.soiscoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.soiscointools.com", true);
        vSeeds.emplace_back("dnsseed.soiscoinpool.org", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0xf02bab15d33de92e68fc59bf4ab08a3ac4964ec5a5b821412152cecfd33b95af")}
        ...
        chainTxData = ChainTxData{
            ...
            1555975847, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(155597611, 433320, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x82ea757a30ab92ccc36bb2c576fb430581e5142850ce4e7f42de76f0dd4906f5"));
        assert(genesis.hashMerkleRoot == uint256S("0xd6a218f16a2361ae76271753045a69777aff83b648f7757261f95f647f4e618a"));
        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        // vSeeds.emplace_back("net-seed.soiscointools.com", true);
        // vSeeds.emplace_back("seed-b.soiscoin.loshan.co.uk", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {2056, uint256S("82ea757a30ab92ccc36bb2c576fb430581e5142850ce4e7f42de76f0dd4906f5")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1555977399, 3, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xaea8fc1a6552954bdfed38c6e6fbf7df102533a5edf76a39104cbe65265869ea"));
        assert(genesis.hashMerkleRoot == uint256S("0xd6a218f16a2361ae76271753045a69777aff83b648f7757261f95f647f4e618a"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("aea8fc1a6552954bdfed38c6e6fbf7df102533a5edf76a39104cbe65265869ea")},
            }
        };
