...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s soiscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  soiscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded soiscoin transaction") + "\n" +
              "  soiscoin-tx [options] -create [commands]   " + _("Create hex-encoded soiscoin transaction") + "\n" +
              "\n";
