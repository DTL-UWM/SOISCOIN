...
const char * const BITCOIN_CONF_FILENAME = "soiscoin.conf";
const char * const BITCOIN_PID_FILENAME = "soiscoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Soiscoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Soiscoin";
#else
    // Unix
    return pathRet / ".soiscoin";
#endif
#endif
}
